...
import { RouteApiAdapter } from "../../infrastruture/adapters/api/RouteApiAdapter";
import { GetRoutesUseCase } from "../../core/application/use-cases/GetRoutesUseCase.ts";
import { SetBaselineUseCase } from "../../core/application/use-cases/SetBaselineUseCase.ts";
import { GetComparisonUseCase } from "../../core/application/use-cases/GetComparisonUseCase.ts";
import type { Route } from "../../core/domain/entities/Route.ts";
import { FilterBar } from "../../infrastruture/adapters/ui/components/FilterBar";
import { RoutesTable } from "../../infrastruture/adapters/ui/components/RoutesTable";
import { CompareChart } from "../../infrastruture/adapters/ui/components/CompareChart";
import { BankingPanel } from "../../infrastruture/adapters/ui/components/BankingPanel";
import { PoolingPanel } from "../../infrastruture/adapters/ui/components/PoolingPanel";
